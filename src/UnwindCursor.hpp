...
#if !FOR_DYLD
template <typename A> class DwarfFDECache
{
  public:
...
template <typename A> pthread_rwlock_t DwarfFDECache<A>::fgLock = PTHREAD_RWLOCK_INITIALIZER;

template <typename A> bool DwarfFDECache<A>::fgRegisteredForDyldUnloads = false;
...
template <typename A> void DwarfFDECache<A>::dyldUnloadHook(const struct mach_header* mh, intptr_t vmaddr_slide)
{
...
template <typename A> class UnwindSectionHeader
{
  public:
    ...
    uint32_t version() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, version));
    }
    uint32_t commonEncodingsArraySectionOffset() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, commonEncodingsArraySectionOffset));
    }
    uint32_t commonEncodingsArrayCount() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, commonEncodingsArrayCount));
    }
    uint32_t personalityArraySectionOffset() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, personalityArraySectionOffset));
    }
    uint32_t personalityArrayCount() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, personalityArrayCount));
    }
    uint32_t indexSectionOffset() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, indexSectionOffset));
    }
    uint32_t indexCount() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_section_header, indexCount));
    }
...
template <typename A> class UnwindSectionIndexArray
{
  public:
    ...
    uint32_t functionOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_section_header_index_entry, index, functionOffset));
    }
    uint32_t secondLevelPagesSectionOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_section_header_index_entry, index, secondLevelPagesSectionOffset));
    }
    uint32_t lsdaIndexArraySectionOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_section_header_index_entry, index, lsdaIndexArraySectionOffset));
    }
...
template <typename A> class UnwindSectionRegularPageHeader
{
  public:
    ...
    uint32_t kind() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_regular_second_level_page_header, kind));
    }
    uint16_t entryPageOffset() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_regular_second_level_page_header, entryPageOffset));
    }
    uint16_t entryCount() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_regular_second_level_page_header, entryCount));
    }
...
template <typename A> class UnwindSectionRegularArray
{
  public:
    ...
    uint32_t functionOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_regular_second_level_entry, index, functionOffset));
    }
    uint32_t encoding(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_regular_second_level_entry, index, encoding));
    }
...
template <typename A> class UnwindSectionCompressedPageHeader
{
  public:
    ...
    uint32_t kind() const INLINE
    {
        return fAddressSpace.get32(fAddr + offsetof(unwind_info_compressed_second_level_page_header, kind));
    }
    uint16_t entryPageOffset() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_compressed_second_level_page_header, entryPageOffset));
    }
    uint16_t entryCount() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_compressed_second_level_page_header, entryCount));
    }
    uint16_t encodingsPageOffset() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_compressed_second_level_page_header, encodingsPageOffset));
    }
    uint16_t encodingsCount() const INLINE
    {
        return fAddressSpace.get16(fAddr + offsetof(unwind_info_compressed_second_level_page_header, encodingsCount));
    }
...
template <typename A> class UnwindSectionCompressedArray
{
  public:
    ...
    uint32_t functionOffset(int index) const INLINE
    {
        return UNWIND_INFO_COMPRESSED_ENTRY_FUNC_OFFSET(fAddressSpace.get32(fAddr + index * sizeof(uint32_t)));
    }
    uint16_t encodingIndex(int index) const INLINE
    {
        return UNWIND_INFO_COMPRESSED_ENTRY_ENCODING_INDEX(fAddressSpace.get32(fAddr + index * sizeof(uint32_t)));
    }
...
template <typename A> class UnwindSectionLsdaArray
{
  public:
    ...
    uint32_t functionOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_section_header_lsda_index_entry, index, functionOffset));
    }
    int32_t lsdaOffset(int index) const INLINE
    {
        return fAddressSpace.get32(fAddr + arrayoffsetof(unwind_info_section_header_lsda_index_entry, index, lsdaOffset));
    }
...
template <typename A, typename R> class UnwindCursor
{
  ...
  private:
    ...
    bool mustUseDwarf() const
    {
        R dummy;
        uint32_t offset;
        return fForceDwarf || dwarfWithOffset(dummy, offset);
    }
#endif
    ...
    {
        R dummy;
        return dwarfWithOffset(dummy, offset);
    }
    ...
    bool dwarfWithOffset(Registers_ppc&, uint32_t& offset) const
    {
        return true;
    }
...
UnwindCursor<A, R>::UnwindCursor(unw_context_t* context, A& as) : fUnwindInfoMissing(false), fIsSignalFrame(false), fForceDwarf(false), fRegisters(context), fAddressSpace(as)
{
    static_assert(sizeof(UnwindCursor<A, R>) < sizeof(unw_cursor_t), "sizeof(UnwindCursor<A,R>) MUST be < sizeof(unw_cursor_t)");

    bzero(&fInfo, sizeof(fInfo));
}

template <typename A, typename R> UnwindCursor<A, R>::UnwindCursor(A& as, thread_t thread) : fUnwindInfoMissing(false), fIsSignalFrame(false), fForceDwarf(false), fAddressSpace(as)
{
    bzero(&fInfo, sizeof(fInfo));
    // FIXME
...
template <typename A, typename R> uint64_t UnwindCursor<A, R>::getReg(int regNum)
{
    return fRegisters.getRegister(regNum);
}

template <typename A, typename R> void UnwindCursor<A, R>::setReg(int regNum, uint64_t value)
{
...
template <typename A, typename R> double UnwindCursor<A, R>::getFloatReg(int regNum)
{
    return fRegisters.getFloatRegister(regNum);
}

template <typename A, typename R> void UnwindCursor<A, R>::setFloatReg(int regNum, double value)
{
...
template <typename A, typename R> bool UnwindCursor<A, R>::getInfoFromDwarfSection(pint_t pc, pint_t mh, pint_t ehSectionStart, uint32_t sectionLength, uint32_t sectionOffsetOfFDE)
{
...
template <typename A, typename R> bool UnwindCursor<A, R>::getInfoFromCompactEncodingSection(pint_t pc, pint_t mh, pint_t unwindSectionStart)
{
    ...
    if (log)
        fprintf(stderr, "\tfirst level search for result index=%d to secondLevelAddr=0x%llX\n", low, (uint64_t) secondLevelAddr);
    ...
    if (pageKind == UNWIND_SECOND_LEVEL_REGULAR)
    {
        ...
        if (log)
            fprintf(stderr, "\tbinary search for targetFunctionOffset=0x%08llX in regular page starting at secondLevelAddr=0x%llX\n", (uint64_t) targetFunctionOffset, (uint64_t) secondLevelAddr);
        uint32_t low = 0;
        ...
        {
            if (log)
                fprintf(stderr, "\tpc not in table, pc=0x%llX, funcStart=0x%llX, funcEnd=0x%llX\n", (uint64_t) pc, (uint64_t) funcStart, (uint64_t) funcEnd);
            return false;
        }
        if (pc > funcEnd)
        {
    ...
    else if (pageKind == UNWIND_SECOND_LEVEL_COMPRESSED)
    {
        ...
        // binary search looks for entry with e where index[e].offset <= pc < index[e+1].offset
        if (log)
            fprintf(stderr, "\tbinary search of compressed page starting at secondLevelAddr=0x%llX\n", (uint64_t) secondLevelAddr);
        uint32_t low = 0;
    ...
    if (encoding & UNWIND_HAS_LSDA)
    {
        ...
        if (log)
            fprintf(stderr, "\tbinary search of lsda table for targetFunctionOffset=0x%08X\n", funcStartOffset);
        while (low < high)
        {
            uint32_t mid = (low + high) / 2;
    ...
    if (personalityIndex != 0)
    {
        ...
        if (log)
            fprintf(stderr, "getInfoFromCompactEncodingSection(pc=0x%llX), personalityDelta=0x%08X, personality=0x%08llX\n", (uint64_t) pc, personalityDelta, (uint64_t) personality);
    }

    if (log)
        fprintf(stderr, "getInfoFromCompactEncodingSection(pc=0x%llX), encoding=0x%08X, lsda=0x%08llX for funcStart=0x%llX\n", (uint64_t) pc, encoding, (uint64_t) lsda, (uint64_t) funcStart);
