...
{
    static_assert(sizeof(Registers_x86) < sizeof(unw_context_t), "sizeof(Registers_x86) MUST be < sizeof(unw_context_t)");
...
{
    static_assert(sizeof(Registers_x86_64) < sizeof(unw_context_t), "sizeof(Registers_x86_64) MUST be < sizeof(unw_context_t)");
    fRegisters = *((GPRs*) registers);
}
...
{
    static_assert(sizeof(Registers_ppc) < sizeof(unw_context_t), "sizeof(Registers_ppc) MUST be < sizeof(unw_context_t)");
