...
#endif
#define DEBUG_LOG_NON_ZERO(x)                                                                                                                                                                          \
    {                                                                                                                                                                                                  \
        int _err = x;                                                                                                                                                                                  \
        if (_err != 0)                                                                                                                                                                                 \
            fprintf(stderr, "libuwind: " #x "=%d in %s", _err, __FUNCTION__);                                                                                                                          \
    }
#define DEBUG_PRINT_API(msg, ...)                                                                                                                                                                      \
    do                                                                                                                                                                                                 \
    {                                                                                                                                                                                                  \
...
#define INITIALIZE_DEBUG_PRINT_API                                                                                                                                                                     \
    bool logAPIs()                                                                                                                                                                                     \
    {                                                                                                                                                                                                  \
        static bool log = (getenv("LIBUNWIND_PRINT_APIS") != NULL);                                                                                                                                    \
        return log;                                                                                                                                                                                    \
    }
#define INITIALIZE_DEBUG_PRINT_UNWINDING                                                                                                                                                               \
    bool logUnwinding()                                                                                                                                                                                \
    {                                                                                                                                                                                                  \
        static bool log = (getenv("LIBUNWIND_PRINT_UNWINDING") != NULL);                                                                                                                               \
        return log;                                                                                                                                                                                    \
    }
#endif
